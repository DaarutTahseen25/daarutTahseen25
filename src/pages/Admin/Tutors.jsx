...
export default function Tutors() {
  ...
  return (
    <div className="min-h-screen">
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="hidden lg:table-cell">
                        <span className="inline-flex items-center px-2 md:px-3 py-1 rounded-full text-xs md:text-sm font-medium bg-blue-100 text-blue-800 border border-blue-200">
                          Quranic Studies
                        </span>
                      </TableCell>
      ...
      {overlay.type === "add" && (
        <AddTeacher open={true} onOpenChange={closeOverlay} onAdd={handleAdd} />
      )}
    </div>
  );
}
