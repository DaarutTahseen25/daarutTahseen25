    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          <Link to="/privacypolicy.jsx" className="text-blue-600 underline">
            Privacy Policy
          </Link>
          .
        </p>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          changes to the Terms of Service on a timely basis. You are expected to
          check the page frequently for updates, as they are binding on you.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          your NIN. You are solely responsible for your login credentials, OTPs,
          and data security.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          verification of Nigerian applicants. We comply with the Nigerian Data
          Protection Act and store this information securely.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p>
          DaarutTahseen reserves the right to suspend or terminate accounts for
          policy violations without notice.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Business Address:</strong> 18, Cucumber Drive, Arowona
            Adegbeye Estate, New Felele, Ibadan.
          </li>
          <li>
            <strong>Email:</strong> daaruttahseeninstitution@gmail.com
          </li>
          <li>
            <strong>Phone:</strong> +2349043609339
          </li>
        </ul>
      </section>
    </div>
