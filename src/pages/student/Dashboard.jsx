...
const Dashboard = () => {
  ...
  const matricNumber = useMemo(() => {
    const profile = user?.user || user;
    return profile?.matric_number;
  }, [user]);

  return (
    <section className="flex flex-col gap-10   ">
      <Header firstName={firstName} id={matricNumber} profile={user} />
...
/* ======================
   Header Section
====================== */
const Header = memo(({ firstName = "Student", id, profile }) => {
  return (
