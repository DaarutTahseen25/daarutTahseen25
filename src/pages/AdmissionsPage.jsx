...
const requirements = [
  ...
  {
    title: "Teacher Credentials (Optional)",
    description: "Upload documents to complete your teaching profile",
    icon: FileText,
    forTeachers: true,
  },
];
        ...
        <div className='relative z-10 w-[90%] sm:w-[85%] md:w-[75%] mx-auto py-20'>
          ...
          <div className='max-w-4xl mx-auto space-y-6'>
            ...
            <div className='p-8'>
              <p className='text-lg sm:text-xl text-gray-700 text-center leading-relaxed'>
                Whether you're a{" "}
                <span className='font-semibold text-[#360400]'>student</span>{" "}
                seeking to deepen your understanding of Islamic knowledge or a{" "}
                <span className='font-semibold text-[#360400]'>teacher</span>{" "}
                ready to share your expertise, DaarutTahseen offers a pathway
        ...
        <div className='w-[90%] sm:w-[85%] md:w-[75%] mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
              Select the registration type that best fits your learning or
              teaching goals
            </p>
          </div>
                  ...
                  <div
                    ...
                    <div className='flex items-start gap-4'>
                      ...
                      <div className='flex-1'>
                        ...
                        {item.forTeachers && (
                          <span className='inline-block mt-2 px-3 py-1 bg-[#009688]/10 text-[#009688] text-sm font-medium rounded-full'>
                            For Teachers Only
                          </span>
                        )}
                      </div>
      ...
      <section className='py-20 relative overflow-hidden'>
        ...
        <div className='relative z-10 w-[90%] sm:w-[85%] md:w-[75%] mx-auto text-center'>
          ...
          <div className='grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto mb-12'>
            <Link to='/create/student-account' className='group'>
              <Button className='w-full py-6 px-8  hover:bg-[#009688] text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 '>
            ...
            <Link to='/create/tutor-account' className='group'>
              <Button className='w-full py-6 px-8  hover:to-[#009688] text-white font-bold text-lg rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 '>
