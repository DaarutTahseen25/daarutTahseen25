...
function CourseCard({ title, description, thumbnail }) {
  return (
    <div className="bg-white w-full max-w-[328px] rounded-[20px] shadow-lg p-6 flex flex-col">
      <img
        src={thumbnail}
        alt={title}
      ...
      <p className=" text-black font-[400] font-montserrat text-left text-[14px] leading-[100%]">
        {description}
      </p>
