  ...
  return (
    <div className="rounded-xl bg-white shadow border border-neutral-200 relative p-3 sm:p-4 w-full max-w-full min-h-[280px] flex flex-col justify-between">
      ...
      <button
        ...
        className={`absolute top-3 right-3 text-xs sm:text-sm font-semibold border px-2 sm:px-3 py-1 sm:py-1.5 border-none ${
          disableSeeAll
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mt-6 sm:mt-2">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mt-1 text-sm">
            <p className="text-gray-500 font-bold">{questions} Questions</p>
            <p className="text-gray-500 font-bold">{duration}</p>
          </div>
          <p className=" text-red-400 ">Submit before: {deadline}</p>
        </div>
      </div>
