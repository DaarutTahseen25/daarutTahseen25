...
const RegistrationCard = ({ title, points, children, directory }) => {
  return (
    <div className="group relative bg-white p-8 border border-gray-200 rounded-3xl  transition-all duration-500 md:w-[80%] mx-auto overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center">
          <Link to={directory} className="block">
            <Button className="w-full bg-[#360400] hover:bg-[#009688] text-white py-4 px-6 rounded-2xl font-semibold text-lg transition-all duration-300 transform  shadow-lg hover:shadow-xl">
              {children}
            </Button>
          </Link>
        </div>
