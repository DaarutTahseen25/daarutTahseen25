...
const ViewAssignmentModal = ({ isOpen, onClose, levelId, assignment }) => {
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 p-6">
            <div className="flex-1 bg-white p-4 rounded-lg flex items-center gap-4 shadow">
              ...
              <div className="flex flex-col">
                <span className="text-gray-500 text-sm">Total Marked</span>
          ...
          <div className="">
            <AssignmentDetails
              ...
              instructions={[
                "Complete the following recitation and theory tasks. Record your audio where required and submit all answers before the due date",
                "Accepted submission format: Audio (MP3, M4A and WAV), Written (PDF and DOCX)",
                "Submission Deadline: 18 July, 2025 ; 4:00 PM",
              ]}
              questionList={[
